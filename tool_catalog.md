...
| `INSERT_IMAGE` | 그림 넣기 | — | done | 10-1 | 클릭 위치 → 파일 · IMAGE |
...
| toolId | 라벨 | 단축키 | 상태 | 로드맵 | 비고 |
|--------|------|--------|------|--------|------|
| `MEASURE_LENGTH` | 길이 | — | done | 8-1 | 점 2개 또는 선분·벡터 |
| `MEASURE_ANGLE` | 각도 | — | done | 8-1 | 측정 (작도 ANGLE과 별개) |
| `MEASURE_AREA` | 넓이 | — | done | 8-1 | 다각형·원·부채꼴·활꼴 |
...
| 7-1 | 선택 · 그룹선택 | ✅ |
| 8-1 | 측정 (길이·각도·넓이) | ✅ |
| 7-2·8-2 | 텍스트·꾸미기 | ◐ (텍스트/꾸미기 done, 체크박스 stub) |
| 9단계 | 변환·타일 | ◐ (변환 5종 done, 타일 stub) |
| 10단계 | 미디어 | ◐ (그림 done · 동영상 Won't · 표 stub) |
| 11단계 | 블록·설정 | ◐ (설정 패널 done · 블록/사용자도구 Won't) |
| 12단계 | 터치·저장·단축키 완성 | 일부 ✅ (테마·저장·SVG done) |
...
| 일자 | 내용 |
|------|------|
| 2026-07-30 | INSERT_IMAGE done · 11-3 설정 패널(테마·격자·스냅·축) · done 46 |
| 2026-07-27 | 8-1 MEASURE_LENGTH·ANGLE·AREA done — 대수 배지·부모 갱신 |
