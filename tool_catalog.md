...
| `SELECT` | 선택 | — | stub | 7-1 | Esc는 작도 취소 전용 (선택 단축키 아님) |
| `GROUP_SELECT` | 그룹선택 | Shift+G | stub | 7-1 | G 단독 = 격자 |
...
| `REGULAR_POLYGON_SIDE` | 정다각형 : 한 변 | — | stub | 6-4 | |
| `REGULAR_POLYGON_CENTER` | 정다각형 : 중심과 한 점 | — | stub | 6-4 | |
| `ANGLE_GIVEN` | 주어진 크기의 각 | — | stub | 6-4 | |
